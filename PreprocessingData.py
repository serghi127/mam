...
walley_sample = "mam_phrases/p1/s10.wav"
walley_sample1 = "mam_phrases/p2/s110.wav"
...
data, sample_rate = librosa.load(walley_sample1)
...
data_path_dict = {
    0: ["mam_phrases/p1/" + file_path for file_path in os.listdir("mam_phrases/p1/")],
    1: ["mam_phrases/p2/" + file_path for file_path in os.listdir("mam_phrases/p2/")]
}
